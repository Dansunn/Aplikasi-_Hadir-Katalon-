...
WebUI.callTestCase(findTestCase('User Modul/Mobile/Login Test Case'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.delay(1)

WebUI.verifyElementText(findTestObject('Dashboard Page/Heading Dashboard Element'), 'Kehadiranmu')

WebUI.delay(1)

WebUI.scrollToElement(findTestObject('Dashboard Page/Menu Koreksi Absen'), 0)

WebUI.delay(1)

WebUI.click(findTestObject('Dashboard Page/Menu Koreksi Absen'))
...
WebUI.click(findTestObject('Koreksi Absen Page/Tombol Jam Keluar'))

WebUI.delay(1)

WebUI.click(findTestObject('Koreksi Absen Page/Tombol Pilih Tahun Jam Keluar'))

WebUI.click(findTestObject('Koreksi Absen Page/Tahun 2024 Button Jam Keluar'))

WebUI.click(findTestObject('Koreksi Absen Page/Button Tgl 19 Feb'))

WebUI.delay(1)

WebUI.dragAndDropToObject(findTestObject('Koreksi Absen Page/Jam 16 Button'), findTestObject('Koreksi Absen Page/Jam 16 Button'))

WebUI.delay(1)

WebUI.dragAndDropToObject(findTestObject('Koreksi Absen Page/Menit 30 Button'), findTestObject('Koreksi Absen Page/Menit 30 Button'))

WebUI.delay(2)

WebUI.click(findTestObject('Koreksi Absen Page/Tombol Tipe Absen'))

WebUI.delay(3)

WebUI.click(findTestObject('Koreksi Absen Page/Span WFO'))
