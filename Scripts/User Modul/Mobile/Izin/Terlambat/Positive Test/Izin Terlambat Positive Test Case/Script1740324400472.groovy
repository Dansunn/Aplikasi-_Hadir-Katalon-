...
WebUI.sendKeys(findTestObject('Izin Page/Keterangan Field'), 'Macet Parah')

WebUI.click(findTestObject('Izin Page/Ajukan Button'))

WebUI.verifyElementText(findTestObject('Izin Page/AlertPermintaan izin terlambat sebelumnya belum di approve'), 'Permintaan izin terlambat sebelumnya belum di approve')
